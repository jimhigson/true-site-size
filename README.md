...
| `clean-command` | `""` | run in the workspace between the head and base builds to isolate them, eg `pnpm purge` — the base builds in a workspace subdir and can otherwise inherit head's `node_modules` |
